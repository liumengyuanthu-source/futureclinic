...
root.addEventListener("change", (event) => {
  ...
  if (event.target.dataset.field === "followUp.required") {
    state.cases[state.selectedCase].followUp.required = event.target.value === "yes";
    render();
  }
